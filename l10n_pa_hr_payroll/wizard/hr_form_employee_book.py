...
class hr_salary_employee_bymonth(models.TransientModel):
    ...
    first_date = fields.Date(string='First Date', required=True, default=_get_default_first_date)
    ...
    def print_report(self):
        ...
        return self.env['report'].get_action(self, 'l10n_pa_hr_payroll.report_hrsalarybymonth', data=data)
